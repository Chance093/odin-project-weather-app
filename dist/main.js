...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "fetchDataOnPageLoad": () => (/* binding */ fetchDataOnPageLoad),
...
async function fetchWeatherData(e) {
    ...
    try{
        ...
        (0,_dom__WEBPACK_IMPORTED_MODULE_0__.renderDates)();
...
async function fetchDataOnPageLoad() {
    try {
        ...
        const data1 = await responses[0].json();
        const data2 = await responses[1].json();
        (0,_dom__WEBPACK_IMPORTED_MODULE_0__.renderLocation)('Las Vegas', 'Nevada');
        (0,_dom__WEBPACK_IMPORTED_MODULE_0__.renderDates)();
        (0,_dom__WEBPACK_IMPORTED_MODULE_0__.renderCurrentWeather)(data1);
        (0,_dom__WEBPACK_IMPORTED_MODULE_0__.renderForecastWeather)(data2);
    } catch(err) {
...
/* harmony export */   "renderDates": () => (/* binding */ renderDates),
...
/* harmony import */ var _imgs_feels_like_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./imgs/feels-like.png */ "./src/imgs/feels-like.png");
/* harmony import */ var _imgs_humidity_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./imgs/humidity.png */ "./src/imgs/humidity.png");
/* harmony import */ var _imgs_wind_speed_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./imgs/wind-speed.png */ "./src/imgs/wind-speed.png");
/* harmony import */ var _imgs_rain_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./imgs/rain.png */ "./src/imgs/rain.png");
/* harmony import */ var _imgs_search_png__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./imgs/search.png */ "./src/imgs/search.png");
...
function renderDates() {
    ...
    currentDate.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(), 'iiii, MM/dd/yyyy');
    monthDays.forEach((md, i) => md.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(), i + 1), 'MM/dd'));
    daysOfWeek.forEach((dw, i) => dw.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date(), i + 1), 'iiii'));
}
...
function renderCurrentWeather(data) {
    ...
    feelsLikeImg.src = _imgs_feels_like_png__WEBPACK_IMPORTED_MODULE_2__;
    humidityImg.src = _imgs_humidity_png__WEBPACK_IMPORTED_MODULE_3__;
    corImg.src = _imgs_rain_png__WEBPACK_IMPORTED_MODULE_5__;
    windImg.src = _imgs_wind_speed_png__WEBPACK_IMPORTED_MODULE_4__;
    searchImg.src = _imgs_search_png__WEBPACK_IMPORTED_MODULE_6__;
}
...
/* harmony export */ });
/* harmony import */ var _imgs_drizzle_png__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../imgs/drizzle.png */ "./src/imgs/drizzle.png");
/* harmony import */ var _imgs_rain_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../imgs/rain.png */ "./src/imgs/rain.png");
/* harmony import */ var _imgs_thunderstorm_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../imgs/thunderstorm.png */ "./src/imgs/thunderstorm.png");
/* harmony import */ var _imgs_clouds_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../imgs/clouds.png */ "./src/imgs/clouds.png");
/* harmony import */ var _imgs_snow_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../imgs/snow.png */ "./src/imgs/snow.png");
/* harmony import */ var _imgs_clear_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../imgs/clear.png */ "./src/imgs/clear.png");
...
function getWeatherImgSrc(data) {
    ...
    switch(weather) {
        case 'Thunderstorm':
            return _imgs_thunderstorm_png__WEBPACK_IMPORTED_MODULE_2__;
        case 'Drizzle':
            return _imgs_drizzle_png__WEBPACK_IMPORTED_MODULE_0__;
        case 'Rain':
            return _imgs_rain_png__WEBPACK_IMPORTED_MODULE_1__;
        case 'Snow':
            return _imgs_snow_png__WEBPACK_IMPORTED_MODULE_4__;
        case 'Clear':
            return _imgs_clear_png__WEBPACK_IMPORTED_MODULE_5__;
        default:
            return _imgs_clouds_png__WEBPACK_IMPORTED_MODULE_3__;
    }
}
...
function sortByDate(data) {
    ...
    data.list.forEach(fc => {
        ...
        switch(currentDate){
            case (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(), 1), 'yyyy-MM-dd'):
                dayOne.push(fc);
                break;
            case (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(), 2), 'yyyy-MM-dd'):
                dayTwo.push(fc);
                break;
            case (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(), 3), 'yyyy-MM-dd'):
                dayThree.push(fc);
                break;
            case (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(), 4), 'yyyy-MM-dd'):
                dayFour.push(fc);
                break;
            case (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date(), 5), 'yyyy-MM-dd'):
                dayFive.push(fc);
                break;
        }
    })
...
function getForecastWeatherImgSrc(data) {
    ...
    sorted.forEach(arr => {
        ...
        switch(weather) {
            case 'Thunderstorm':
                sources.push(_imgs_thunderstorm_png__WEBPACK_IMPORTED_MODULE_2__);
                break;
            case 'Drizzle':
                sources.push(_imgs_drizzle_png__WEBPACK_IMPORTED_MODULE_0__);
                break;
            case 'Rain':
                sources.push(_imgs_rain_png__WEBPACK_IMPORTED_MODULE_1__);
                break;
            case 'Snow':
                sources.push(_imgs_snow_png__WEBPACK_IMPORTED_MODULE_4__);
                break;
            case 'Clear':
                sources.push(_imgs_clear_png__WEBPACK_IMPORTED_MODULE_5__);
                break;
            default:
                sources.push(_imgs_clouds_png__WEBPACK_IMPORTED_MODULE_3__);
        }
    });
    return sources;
}
...
module.exports = __webpack_require__.p + "8c58aaa5d8935e6ffd70.png";
...
module.exports = __webpack_require__.p + "72b3800af92f87383d4b.png";

/***/ }),

/***/ "./src/imgs/drizzle.png":
/*!******************************!*\
  !*** ./src/imgs/drizzle.png ***!
  \******************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "b8f6c796e8ebdd7df6c5.png";

/***/ }),

/***/ "./src/imgs/feels-like.png":
/*!*********************************!*\
  !*** ./src/imgs/feels-like.png ***!
  \*********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "9cc48e48f9067ff64525.png";
...
module.exports = __webpack_require__.p + "0bbb54b0b4980172f7d0.png";
...
module.exports = __webpack_require__.p + "d7a42b9163a5734c862e.png";
...
module.exports = __webpack_require__.p + "ad04d21c0262da539f0a.png";
...
module.exports = __webpack_require__.p + "7f8bdba7ff792ed5ff28.png";

/***/ }),

/***/ "./src/imgs/thunderstorm.png":
/*!***********************************!*\
  !*** ./src/imgs/thunderstorm.png ***!
  \***********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "f1d19a407c0cbe7112e1.png";

/***/ }),

/***/ "./src/imgs/wind-speed.png":
/*!*********************************!*\
  !*** ./src/imgs/wind-speed.png ***!
  \*********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "799131e98a7f8f03c28f.png";
...
(0,_api__WEBPACK_IMPORTED_MODULE_0__.fetchDataOnPageLoad)();
